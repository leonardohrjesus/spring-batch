package com.example.leonardo.conf;
...
import com.example.leonardo.service.AutobotItemProcessor;
...
public class BatchConfiguration {
	...
	public FlatFileItemReader<Autobot> reader() {
		...
		//reader.setResource(new FileSystemResource("resource/sample-data.csv"));
